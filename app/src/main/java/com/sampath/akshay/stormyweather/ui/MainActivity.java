...
import com.sampath.akshay.stormyweather.weather.CurrentWeather;
import com.sampath.akshay.stormyweather.weather.DailyWeather;
import com.sampath.akshay.stormyweather.weather.Forecast;
...
public class MainActivity extends AppCompatActivity{
    ...
    @Bind(R.id.messageLabel) TextView mSummaryLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //final double latitude = 43.5794155;
        //final double longitude = -79.6503849;

        final double latitude = 12.9227517;
        final double longitude = 80.1351515;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "61ee0ed3cd600a9b6d2c8da38dd467aa";
    ...
    private HoursWeather[] getHourlyForecast(String jsonData) throws JSONException{
        JSONObject forecast = new JSONObject(jsonData);
        String timezone = forecast.getString("timezone");
        JSONObject hourly = forecast.getJSONObject("hourly");
        JSONArray data = hourly.getJSONArray("data");

        HoursWeather[] hours = new HoursWeather[data.length()];
